...
public class admin_funcs extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					admin_funcs frame = new admin_funcs();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public static void setMember_acc(String member_acc) {
		admin_funcs.member_acc = member_acc;
	}
	
	public static String getMember_acc() {
		return admin_funcs.member_acc;
	}
	...
	public admin_funcs() {
		...
		JLabel m_nn_lbl = new JLabel(new member_implement().read_member_nn(admin_funcs.member_acc));
		...
		ImageIcon shop_img = new ImageIcon(this.getClass().getResource("/swimsuit.png"));
		JLabel shop_pic = new JLabel(shop_img);
		shop_pic.setBounds(33, 20, 64, 64);
		shop.add(shop_pic);
		
		JLabel shop_t = new JLabel("商品上架");
		...
		JLabel shop_rec_t = new JLabel("訂單記錄");
		...
		info_m.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				read_member.setMember_acc(member_acc);
				read_member rm = new read_member();
				rm.setVisible(true);
			}
			@Override
		...
		shop.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				ImageIcon shop_img_b = new ImageIcon(this.getClass().getResource("/swimsuit_b.png"));
		...
		shop_rec.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				order_rec.setMember_acc(member_acc);
				order_rec or = new order_rec();
				or.setVisible(true);
			}
			@Override
			public void mouseEntered(MouseEvent e) {
