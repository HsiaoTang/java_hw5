...
public class calendar_display_sd extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					calendar_display_sd frame = new calendar_display_sd();
	...
	public static void setS_d(String s_d) {
		calendar_display_sd.s_d = s_d;
	}
	
	public static String getS_d() {
		return calendar_display_sd.s_d;
	}
	
	/**
	 * Create the frame.
	 */
	public calendar_display_sd() {
		...
		l_y.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				d_p.removeAll();
				util_member.regen_cal(d_p, y_tf, m_tf, calendar_display_sd.this, purchase_rec.s_d_tf);
				d_p.revalidate();
				d_p.repaint();
			}
		});
...
;					date.set(Calendar.YEAR, y);
				...
				public void mousePressed(MouseEvent e) {
					...
					purchase_rec.s_d_tf.setText(s_d);
					dispose();
				}
